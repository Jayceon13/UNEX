<template>
  <div class="dialog" v-if="showSa" @click.stop="hideBlock">
    <div @click.stop class="dialog__content">
      ...
      <div class="high-term">
        <p style="width: 50%; text-align: center">Вес
          от 7кг</p>
        <p style="width: 50%; text-align: center">Срок
          10-12 дней</p>
      </div>
    </div>
  </div>
