    ...
    <div class="burgerMenuLeft"
      ...
      >
        ...
        >
          ...
          <div class="buttons-block"
               @mouseenter="checkScreenWidth5"
               @mouseleave="showList5 = false">
            <btn
              @click="showList5 = true"
              class="buttons-header"
            >
              КЛИЕНТЫ
            </btn>
            <transition name="list-animation">
              <div v-if="showList5"
                   class="list2"
                   @click="showList5 = false">

                <btn
                  @click="() => { $router.push('/projects'); blockBurgerMenu(); blockShowList5()}"
                  :class="$route.path === '/achievements' ? 'active-button' : 'buttons-header'"
                >
                  КЛИЕНТЫ
                </btn>
          ...
          <div class="buttons-block"
               @mouseenter="checkScreenWidth4"
               @mouseleave="showList4 = false">
            <btn
              @click="showList4 = true"
              class="buttons-header"
            >
              КОНТАКТЫ
            </btn>
            <transition name="list-animation">
              <div v-if="showList4"
                   class="list2"
                   @click="showList4 = false">

                <btn
                  @click="() => { $router.push('/contacts'); blockBurgerMenu(); blockShowList4()}"
...
export default {
  ...
  setup() {
    ...
    const showList4 = ref(false)
    const showList5 = ref(false)
    ...
    return {
      ...
      blockShowList4() {
        showList4.value = !showList4.value
      },
      blockShowList5() {
        showList5.value = !showList5.value
      },
      showBurgerMenu,
      blockBurgerMenu() {
